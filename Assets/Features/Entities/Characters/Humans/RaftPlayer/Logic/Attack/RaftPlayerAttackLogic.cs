    ...
    public class RaftPlayerAttackLogic : RaftPlayerLogic
    {
        ...
        public override void OnSpawned()
        {
            ...
            _player.AnimateLogic.PaddleSwingStateAnimationEvents.Add(
                new StateAnimationEvent(0f, () => _player.EntityPhysicsLogic.NetworkRigidbody.AddForce(_player.transform.forward * _settings.PaddleLungeStrength, ForceMode.Impulse)));
            ...
            _player.AnimateLogic.SpearJab1StateAnimationEvents.Add(
                new StateAnimationEvent(0.2f, () => _player.EntityPhysicsLogic.NetworkRigidbody.AddForce(_player.transform.forward * _settings.SpearLungeStrength, ForceMode.Impulse)));
